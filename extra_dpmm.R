...
# R code taken from "A tutorial on Dirichlet process mixture modeling"
# by Yuelin Li, Elizabeth Schofield, Mithat Gönen,
# Journal of Mathematical Psychology, Volume 91, 2019
# Pages 128-144,
# ISSN 0022-2496, DOI: https://doi.org/10.1016/j.jmp.2019.04.004.
###############################################################################
...
z[n] <- -1 # ensures z[n] doesnÃ•t get counted as a cluster ##### 
##
